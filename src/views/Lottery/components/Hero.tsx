  ...
  return (
    <Flex flexDirection="column" alignItems="center" justifyContent="center">
      ...
      <StarsDecorations display={['none', 'none', 'block']}>
        ...
        <img src="/images/safemoon2.jpeg" className="flip-image" width="123px" height="83px" alt="" />
        <img src="/images/safemoon2.jpeg" width="121px" height="72px" alt="" />
      </StarsDecorations>
      <Heading mb="8px" scale="md" color="#ffffff" id="lottery-hero-title">
        {t('The Safemoon Lottery')}
      </Heading>
      {getHeroHeading()}
      <TicketContainer
        position="relative"
