    ...
    <StyledStepCard width={['280px', '330px', '380px']}>
      <StepCardInner height="auto">
        ...
        <AllocationGrid>
          ...
          <AllocationMatch color="#D750B2" text={t('Matches first %digits%', { digits: 6 })} />
          <Text textAlign="right" bold>
            37%
          </Text>
          ...
          <AllocationMatch color="#a0f858" text={t('Funding Pool')} />
          <Text textAlign="right" bold>
            5%
          </Text>
        </AllocationGrid>
    ...
    <Box width="100%">
      ...
      <GappedFlex flexDirection={['column', 'column', 'column', 'row']}>
        <Flex flex="2" flexDirection="column">
          <Heading mb="24px" fontFamily={'Super Tasty'} scale="lg" color="secondary">
            {t('Winning Criteria')}
          </Heading>
      ...
      <GappedFlex flexDirection={['column', 'column', 'column', 'row']}>
        <Flex flex="2" flexDirection="column">
          <Heading fontFamily={'Super Tasty'} mb="24px" scale="lg" color="secondary">
            {t('Prize Funds')}
          </Heading>
